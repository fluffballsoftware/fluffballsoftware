...
const projects = [
  {
    ...
    tags: ['Next.js', 'AWS', 'WebSocket', 'Android', 'iOS'],
...

  {
    ...
    title: 'Start-Up Pack',
    category: 'Full Stack',
    description: 'From idea to live product with pre-built templates. Includes CI/CD, automated tests, reliable hosting, email setup, and vulnerability scanning.',
    tags: ['Next.js', 'Terraform', 'Stripe', 'CI/CD'],
